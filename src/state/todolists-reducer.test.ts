...
import { addTodolistAC, changeTodoFilterAC, changeTodoTitleAC, removeTodolistAC, todolistsReducer } from './todolists-reducer';
...
test('correct filter of todolist should be changed', () => {
  ...
  const newFilter: keyof IFilterValues = 'completed';
